...
impl OctreeNode {
    pub fn new(size: u16,pos: IVec3,full: bool) -> Self {
        OctreeNode {
            is_full: full,
            //is_orphan: full,
            has_children: false,
...
impl Octree {
    pub fn new(size: u16, pos: IVec3) -> Self {
        let mut s = size ;
        while s != 1 {
    ...
    pub fn new_full(size: u16, pos: IVec3) -> Self {
        let mut s = size ;
        while s != 1 {
            assert!(s % 2 == 0, "the size of the quad tree must be a power of two");
            s /= 2;
    ...
    fn devide_node(&mut self, node_idx: i32,full: bool) {
        ...
        let nodes = [
                OctreeNode::new(half_size as u16,        pos,                                                    ,full), 
                OctreeNode::new(half_size as u16, ivec3!(pos.x            , pos.y            , pos.z + half_size),full),
                OctreeNode::new(half_size as u16, ivec3!(pos.x            , pos.y + half_size, pos.z            ),full),
                OctreeNode::new(half_size as u16, ivec3!(pos.x            , pos.y + half_size, pos.z + half_size),full),
                OctreeNode::new(half_size as u16, ivec3!(pos.x + half_size, pos.y            , pos.z            ),full),
                OctreeNode::new(half_size as u16, ivec3!(pos.x + half_size, pos.y            , pos.z + half_size),full),
                OctreeNode::new(half_size as u16, ivec3!(pos.x + half_size, pos.y + half_size, pos.z            ),full),
                OctreeNode::new(half_size as u16, ivec3!(pos.x + half_size, pos.y + half_size, pos.z + half_size),full),
        ];
